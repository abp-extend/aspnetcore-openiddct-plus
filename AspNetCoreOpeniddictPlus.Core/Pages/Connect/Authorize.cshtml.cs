...
namespace AspNetCoreOpeniddictPlus.Core.Pages.Connect;
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        identity.SetDestinations(claim =>
            claim.Type switch
            {
                ...
                Claims.AuthenticationContextReference or Claims.AuthenticationTime =>
                ...
                or Claims.UpdatedAt
                    when identity.HasScope(Scopes.Profile)
                        ...
                        && !request.HasResponseType(ResponseTypes.Token) => ImmutableArray.Create(
                    Destinations.AccessToken,
                    Destinations.IdentityToken
                ),

                Claims.Email
                    when identity.HasScope(Scopes.Email)
                        && !request.HasResponseType(ResponseTypes.Code)
                        && !request.HasResponseType(ResponseTypes.Token) => ImmutableArray.Create(
                    Destinations.AccessToken,
                    Destinations.IdentityToken
                ...
                Claims.PhoneNumber
                    when identity.HasScope(Scopes.Phone)
                        && !request.HasResponseType(ResponseTypes.Code)
                        && !request.HasResponseType(ResponseTypes.Token) => ImmutableArray.Create(
                    Destinations.AccessToken,
                    Destinations.IdentityToken
                ...
                Claims.Address
                    when identity.HasScope(Scopes.Address)
                        && !request.HasResponseType(ResponseTypes.Code)
                        && !request.HasResponseType(ResponseTypes.Token) => ImmutableArray.Create(
                    Destinations.AccessToken,
                    Destinations.IdentityToken
