...
{
    [DbContext(typeof(OpeniddictPlusDbContext))]
    [Migration("20250204083439_AddedCreatedandModifiedColumn")]
    partial class AddedCreatedandModifiedColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AspNetCoreOpeniddictPlus.Identity.Entities.OpeniddictPlusRole", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityRole", null)
                        .WithOne()
                        .HasForeignKey("AspNetCoreOpeniddictPlus.Identity.Entities.OpeniddictPlusRole", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
